...
**beta3:** `RELEASE-NOTES-v1.0.0-beta.4.md` written. package.json stays beta.1 here; Ken bumps + propagates the 2 health constants atomically at release.
