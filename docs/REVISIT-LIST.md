...
| 2 | Status | "Approaching `v1.0.0-beta.3` (~2026-05-22)" (stale date; pkg already at that version) | "Pre-launch, versioned `v1.0.0-beta.3`." |
...
Verified accurate, left unchanged: the 7-package list, ADR range "through 0046", the `v1.0.0-beta.3` string (matches package.json), the "§16 of the form" reference (bug_report.md §16 exists), and all 17 referenced paths resolve.  No code, no brag-list, no locale, no mediakit.
...
`'morphit-mcp/1.0.0-beta.3 (+https://morphit.io)'`.  When the package version bumps to 1.0.0-beta.2 or 1.0.0, this string silently drifts.
...
- Scenario 1: ✗ — named missing packages: `morphit-mcp@1.0.0-beta.3`, `@modelcontextprotocol/sdk@1.29.0`, `ajv@8.20.0`, `ajv-formats@3.0.1`, `cors@2.8.6`, …
