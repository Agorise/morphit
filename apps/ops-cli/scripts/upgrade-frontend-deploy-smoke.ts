...
// ─── FD-21/22: served-frontend freshness verification (beta14) ──────
{
	...
	if (v === '1.0.0-beta.19') ok('FD-21a parseVerifyJsonVersion extracts morphit_version from the real verify.json shape');
	...
	if (
		...
		parseVerifyJsonVersion('{"version":"1.0.0-beta.19"}') === null
	)
