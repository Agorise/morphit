...
const scenarios: Scenario[] = [
	...
	{
		name: 'relay-acts relay_low_balance_for_signups → CRITICAL (signups refused, relay below account-creation fee)',
		alert: a('relay-acts', 'relay_low_balance_for_signups', {
			account: 'morphit-relay',
			blurt_balance: '50.000 BLURT',
			required_blurt: 102
		}),
		expectedTier: 'CRITICAL'
	}
