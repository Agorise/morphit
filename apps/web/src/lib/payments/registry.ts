...
export const PAYMENT_METHODS: readonly PaymentMethodEntry[] = [
	...
	{
		// Cardless ATM cash pickup: the payer generates a code the
		// payee redeems at a cash machine to withdraw physical cash
		// with no card and no bank account. Remote coordination (a
		// code is shared, no meetup), so it lives under 'online'
		// rather than 'in_person'.
		key: 'cash_machine_code',
		name: 'Cash machine with code',
		url: null,
		category: 'online'
	},
	{
