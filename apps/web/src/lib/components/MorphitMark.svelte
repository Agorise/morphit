<script lang="ts">
	...
	let { size = 48, class: cls = '', animate = false }: Props = $props();
</script>
		...
		>
			<stop offset="0" stop-color="#8EEF26">
				{#if animate}<animate
						...
						values="#8EEF26;#00DA69;#02A6B2;#8EEF26"
						dur="8s"
			...
			<stop offset="0.502" stop-color="#00DA69">
				{#if animate}<animate
						attributeName="stop-color"
						values="#00DA69;#02A6B2;#8EEF26;#00DA69"
						dur="8s"
						repeatCount="indefinite"
					/>{/if}
			</stop>
			<stop offset="1" stop-color="#02A6B2">
				{#if animate}<animate
						attributeName="stop-color"
						values="#02A6B2;#8EEF26;#00DA69;#02A6B2"
						dur="8s"
						repeatCount="indefinite"
					/>{/if}
			</stop>
