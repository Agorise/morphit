...
{#if loaded && visible}
	<div
		class="mx-3 mb-2 mt-2 rounded-xl border-2 border-blue-400/40 bg-blue-400/5 p-3"
	...
	>
		<div class="mb-2 flex items-start justify-between gap-2">
			...
			<button
				type="button"
				onclick={dismiss}
				class="-mr-1 -mt-1 rounded-md px-2 py-1 text-xs text-ink-600 hover:bg-blue-400/10 hover:text-ink-800 dark:text-ink-400 dark:hover:text-ink-200"
