...
>
	...
	<label class="mb-3 block">
		...
		<input
			...
			class="w-full rounded-xl border-2 border-ink-200 bg-white px-3 py-2 font-mono text-sm focus:border-morphit-emerald focus:outline-none dark:border-ink-700 dark:bg-ink-900"
			disabled={submitting}
		/>
	</label>
	{#if subjectError}
