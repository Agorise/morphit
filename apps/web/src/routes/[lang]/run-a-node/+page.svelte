				...
				>
					<div>
						...
						<input
							...
							class="block w-full rounded-xl border border-ink-300 bg-white px-4 py-3 font-mono focus:outline-none dark:border-ink-700 dark:bg-ink-900"
						/>
					...
					<div>
						...
						<input
							...
							class="block w-full rounded-xl border border-ink-300 bg-white px-4 py-3 focus:outline-none dark:border-ink-700 dark:bg-ink-900"
						/>
						<p class="mt-1 text-xs text-ink-500">
