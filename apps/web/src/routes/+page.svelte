...
<section class="relative overflow-hidden">
	...
	<div class="mx-auto max-w-6xl px-4 py-16 md:px-6 md:py-24">
		<div class="flex flex-col items-center text-center">
			...
			>
				<a href="/orderbook" class="btn-primary">{$_('home.cta_browse')}</a>
				<a href="/onboarding" class="btn-secondary">{$_('home.cta_start')}</a>
			</div>
			...
			>
				...
				<a href="/login" class="font-semibold text-morphit-emerald hover:underline">
