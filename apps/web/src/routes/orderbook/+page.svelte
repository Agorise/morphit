...
<div class="mx-auto max-w-4xl px-4 py-10 md:py-14">
	<header class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
		...
		<a href="/post" class="btn-primary self-start whitespace-nowrap">
	...
	{#if $hasAnySession && viewerAccount !== null}
		...
		<p class="mb-4 text-xs text-ink-500 dark:text-ink-400">
			<a href="/my/orders#fee-status" class="underline hover:no-underline">
	...
	{#if $isUnlocked && viewerAccount === null}
		...
		>
			<div class="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
				...
				<a href="/onboarding/register-name" class="btn-primary flex-none whitespace-nowrap">
