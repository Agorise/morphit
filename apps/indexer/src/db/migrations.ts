...
const MIGRATIONS: readonly Migration[] = [
	{
		version: 1,
		description: 'collapsed canonical schema (v1-v27 merged, May 2026 audit)',
		...
		// as applying v1-v27 incrementally; this list preserves the
	...
	// Future migrations land here.  The collapse happens once
	// pre-launch; from this point forward, every new schema change
	// is its own additive migration with its own version number
	// (28, 29, ...).  No further collapse should happen until
	// well after 1.0.0 ships.
];
