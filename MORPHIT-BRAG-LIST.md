...
29. **Sharing your public address goes through a privacy-aware modal.** Not just a copy-paste field — a flow that asks about subaddress preferences (XMR), amount-jitter (every transparent asset: BTC/BCH/LTC/DASH/BLURT/XMR), client-side address-reuse detection (warns when you're about to share an address you've shared from this device before), and optional PayJoin (BIP-78) endpoint for BTC. Untraceability is the mission.
...
- **Architecture decisions**: `docs/adr/0001-*.md` through `docs/adr/0027-*.md`
