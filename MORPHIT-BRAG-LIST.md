...
35. **Over 3,306 self-checking smoke scenarios** ship with the source code. Run them yourself: `bash scripts/run-smokes.sh`. They cover the indexer, relay, ops CLI, frontend bus, payments, federation probe, fee verification, chat encryption, and more.
...
- **Smoke suite**: `bash scripts/run-smokes.sh` — runs **3,306+ self-checks across 140+ runners**, triple-pulse stable
