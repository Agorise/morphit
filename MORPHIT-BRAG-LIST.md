...
30. **Over 3,170 self-checking smoke scenarios** ship with the source code. Run them yourself: `bash scripts/run-smokes.sh`. They cover the indexer, relay, ops CLI, frontend bus, payments, federation probe, fee verification, chat encryption, and more.
